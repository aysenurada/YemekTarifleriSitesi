...
namespace YemekTarifleriWebSite
{
    public partial class TarifOner : System.Web.UI.Page
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Insert Into TblTarifler (TarifAd, TarifMalzeme, TarifYapilis, TarifResim, TarifSahip, TarifSahipMail) Values (@t1, @t2, @t3, @t4, @t5, @t6)", bgl.baglanti());
