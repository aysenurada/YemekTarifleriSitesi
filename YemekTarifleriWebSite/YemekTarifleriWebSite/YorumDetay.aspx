...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style6">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtAd" runat="server" Height="30px" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtYemek" runat="server" Height="30px" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>
                <asp:Button ID="BtnOnayla" runat="server" BackColor="#FFFF99" CssClass="auto-style8" Height="35px" OnClick="BtnOnayla_Click" Text="Onayla" Width="100px" />
                </strong></td>
        </tr>
    </table>
</asp:Content>
